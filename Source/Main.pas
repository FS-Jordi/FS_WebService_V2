...
begin
  ...
  gaLogFile.Write ( 'Conexión aceptada. Host: ' + AConnection.PeerIP, CONST_LOGID_WEBSERVER, LOG_LEVEL_INFO );
  Inc(giNumSessions);
...
begin
  ...
  if not FIsStop then
  begin
    gaLogFile.Write ( 'Conexión cerrada. Host: ' + AConnection.PeerIP, CONST_LOGID_WEBSERVER, LOG_LEVEL_INFO );
  end;
