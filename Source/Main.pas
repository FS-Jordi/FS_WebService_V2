...
type
  TFS_MainWebServiceSGA = class(TService)
    ...
    ppParameter26: TppParameter;
    ppParameter27: TppParameter;
    ppParameter28: TppParameter;
    ppParameter29: TppParameter;
    ppParameter30: TppParameter;
    ppParameter31: TppParameter;
    ppParameter32: TppParameter;
    ppParameter33: TppParameter;
    ppParameter34: TppParameter;
    ppParameter35: TppParameter;
    ppParameter36: TppParameter;
    ppParameter37: TppParameter;
    ppParameter38: TppParameter;
    ppParameter39: TppParameter;
    ppParameter40: TppParameter;
    ppParameter41: TppParameter;
    ppParameter42: TppParameter;
    ppParameter43: TppParameter;
    ppParameter44: TppParameter;
    ppParameter45: TppParameter;
    ppParameter46: TppParameter;
    ppParameter47: TppParameter;
...
begin
  ...
  try
    ...
    else if (sCommand='/checknumeroserieenstock') then
    begin
      TAsyncWebModuleThread.Create(
        SQLConn.ConnectionString,
      sParams,
      AConnection.PeerIP,
      @WebModule1checkNumeroSerieEnStockAction,
      HttpServer,
      AConnection,
      AConnection.ResponseHeader.ContentType,
      AConnection.ResponseHeader.CharSet,
    ...
    else if (sCommand='/getnumerosserieubicacion') then
    begin
      TAsyncWebModuleThread.Create(
        SQLConn.ConnectionString,
      sParams,
      AConnection.PeerIP,
      @WebModule1getNumerosSerieSalidaStockAction,
      HttpServer,
      AConnection,
      AConnection.ResponseHeader.ContentType,
      AConnection.ResponseHeader.CharSet,
